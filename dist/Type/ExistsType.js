...
exports.ChoiceConfig = undefined;
...
var ChoiceConfig = exports.ChoiceConfig = function () {
    function ChoiceConfig() {
        ...
        _classCallCheck(this, ChoiceConfig);
    ...
    _createClass(ChoiceConfig, null, [{
        key: 'create',
...
ExistsType.propTypes = {
    choice: _propTypes2.default.instanceOf(ChoiceConfig)
};
