...
var NumberType = function (_StringType) {
    ...
    _createClass(NumberType, [{
        ...
        value: function getOperators() {
            ...
            return _ref = {}, _defineProperty(_ref, FILTER_EQUAL, 'Equal'), _defineProperty(_ref, FILTER_NOT_EQUAL, 'Not Equal'), _defineProperty(_ref, FILTER_CONTAINS, 'Contains'), _defineProperty(_ref, FILTER_NOT_CONTAINS, 'Not Contains'), _defineProperty(_ref, FILTER_IN, 'In'), _defineProperty(_ref, FILTER_NOT_IN, 'Not In'), _defineProperty(_ref, FILTER_BETWEEN, 'Between'), _defineProperty(_ref, FILTER_NOT_BETWEEN, 'Not Between'), _defineProperty(_ref, FILTER_GREATER_THAN, 'Greater than'), _defineProperty(_ref, FILTER_GREATER_THAN_EQUALS, 'Greater than equals'), _defineProperty(_ref, FILTER_LESS_THAN, 'Less than'), _defineProperty(_ref, FILTER_LESS_THAN_EQUALS, 'Less than equals'), _ref;
        }
