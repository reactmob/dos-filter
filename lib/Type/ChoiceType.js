...
exports.ChoiceRemoteConfig = undefined;
...
var _RemoteConfig = require('./ChoiceType/RemoteConfig');
...
var ChoiceRemoteConfig = exports.ChoiceRemoteConfig = _RemoteConfig2.default;

var ChoiceType = function (_AbstractType) {
    _inherits(ChoiceType, _AbstractType);

    function ChoiceType(props) {
        _classCallCheck(this, ChoiceType);

        var _this = _possibleConstructorReturn(this, (ChoiceType.__proto__ || Object.getPrototypeOf(ChoiceType)).call(this, props));
...
ChoiceType.defaultOperator = FILTER_EQUAL;
