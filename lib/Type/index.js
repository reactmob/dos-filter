...
exports.StringType = exports.NumberType = exports.ChoiceConfig = exports.ExistsType = exports.DateType = exports.ChoiceRemoteConfig = exports.ChoiceType = undefined;

var _ChoiceType2 = require('./ChoiceType');

Object.defineProperty(exports, 'ChoiceRemoteConfig', {
  enumerable: true,
  get: function get() {
    return _ChoiceType2.ChoiceRemoteConfig;
  }
});
...
var _ChoiceType3 = _interopRequireDefault(_ChoiceType2);
...
exports.ChoiceType = _ChoiceType3.default;
